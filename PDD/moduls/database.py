...
class Settings (Frame):
  ...
  def create_widgets (self):
    ...
    self.log__path_ent = MyEntry  (self, rw = 11, cl = 2, st = W, text = conf.get ('LOG', 'path'))
    self.log__name_lbl = MyLabel  (self, rw = 12, cl = 1, st = W, text = 'Имя файла')
    self.log__name_ent = MyEntry  (self, rw = 12, cl = 2, st = W, text = conf.get ('LOG', 'name'))
    ...
    self.wind_wdt__ent = MyEntry  (self, rw = 15, cl = 2, st = W, text = conf.get ('WINDOW', 'width'))
    self.wind_hgt__lbl = MyLabel  (self, rw = 16, cl = 1, st = W, text = 'Высота')
    self.wind_hgt__ent = MyEntry  (self, rw = 16, cl = 2, st = W, text = conf.get ('WINDOW', 'height'))
    self.wind_xstp_lbl = MyLabel  (self, rw = 17, cl = 1, st = W, text = 'Левый край')
    self.wind_xstp_ent = MyEntry  (self, rw = 17, cl = 2, st = W, text = conf.get ('WINDOW', 'x_step'))
    self.wind_ystp_lbl = MyLabel  (self, rw = 18, cl = 1, st = W, text = 'Верхний край')
    self.wind_ystp_ent = MyEntry  (self, rw = 18, cl = 2, st = W, text = conf.get ('WINDOW', 'y_step'))
    self.tckt_sect_lbl = MyLabel  (self, rw = 19,         st = W, text = 'Билеты')
    self.tckt_cnt__lbl = MyLabel  (self, rw = 20, cl = 1, st = W, text = 'Количество')
    self.tckt_cnt__ent = MyEntry  (self, rw = 20, cl = 2, st = W, text = conf.get ('TICKET', 'count'))
    self.tckt_strt_lbl = MyLabel  (self, rw = 21, cl = 1, st = W, text = 'Начальный')
    self.tckt_strt_ent = MyEntry  (self, rw = 21, cl = 2, st = W, text = conf.get ('TICKET', 'start'))
    self.qstn_sect_lbl = MyLabel  (self, rw = 22,         st = W, text = 'Вопросы')
    self.qstn_cnt__lbl = MyLabel  (self, rw = 23, cl = 1, st = W, text = 'Количество')
    self.qstn_cnt__ent = MyEntry  (self, rw = 23, cl = 2, st = W, text = conf.get ('QUESTION', 'count'))
    self.qstn_strt_lbl = MyLabel  (self, rw = 24, cl = 1, st = W, text = 'Начальный')
    self.qstn_strt_ent = MyEntry  (self, rw = 24, cl = 2, st = W, text = conf.get ('QUESTION', 'start'))
    self.answ_sect_lbl = MyLabel  (self, rw = 25,         st = W, text = 'Ответы')
    self.answ_cnt__lbl = MyLabel  (self, rw = 26, cl = 1, st = W, text = 'Количество')
    self.answ_cnt__ent = MyEntry  (self, rw = 26, cl = 2, st = W, text = conf.get ('ANSWER', 'count'))
    self.answ_strt_lbl = MyLabel  (self, rw = 27, cl = 1, st = W, text = 'Начальный')
    self.answ_strt_ent = MyEntry  (self, rw = 27, cl = 2, st = W, text = conf.get ('ANSWER', 'start'))
    ...
    self.lgc__err__ent = MyEntry  (self, rw = 29, cl = 2, st = W, text = conf.get ('LOGIC', 'max_error'))
  ...
  def save (self):
    ...
    conf.set ('LOG',      'path',      self.log__path_ent.get ())
    conf.set ('LOG',      'name',      self.log__name_ent.get ())
